...
- **On a phone or tablet:** put a finger anywhere on the village and **drag** —
  ...
  boxes fold away when you tap their headings, and once you tap into the
  message box the phrase trays come down to one row so the composer and the
  conversation stay in view above the keyboard.
